        ...
        <div class="container">
            ...
            <div class="section-1 py-20">
                <div class="column float-right ">
                    ...
                    <div class="grid grid-cols-4 mt-4 pl-7">
                        <Link to="/contact" class="hover:text-blue-200"><FaEnvelope size={24}/></Link>
                        ...
                        <a href='https://www.kaggle.com/cordellbrowne'target="_blank" rel="noreferrer"  className="hover:text-sky-300"><FaKaggle size={22}/></a>
                    </div>
                </div>
